...
namespace InventoryDemo.Infrastructure.Migrations
{
    ...
    [Migration("20230620160438_add a relationship table between operators and machine ")]
    partial class addarelationshiptablebetweenoperatorsandmachine
    {
            ...
            modelBuilder.Entity("MachinesOperators", b =>
                {
                    ...
                    b.ToTable("OperatorAndMachine", (string)null);
                });
